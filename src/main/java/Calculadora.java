public class Calculadora {
    ...
    public double porcentaje(int parte, int total) {
        ...
        if (total == 0) {
            System.out.println("⚠️ Error: intento de calcular porcentaje con total cero.");
            throw new ArithmeticException("No se puede dividir por cero");
        }
    ...
    public double raizCuadrada(double x) {
        ...
        if (x < 0) {
            System.out.println("⚠️ Error: intento de calcular raíz cuadrada de número negativo.");
